...
class MigrationShell extends Shell {
    ...
    public function startup() {
        ...
        $this->out(String::insert(
                        __d('migrations', 'Path to migrations classes: :path', true), array('path' => $this->path)
        ));
        $this->out(String::insert(
                        __d('migrations', 'Connection to the database: :connection', true), array('connection' => $this->connection)
        ));
        $this->out(String::insert(
     ...
     * @access protected
     */
    public function _startDBConfig() {
    ...
    public function create() {
        ...
        $this->out(String::insert(
                        __d('migrations', 'The file is in: :file', true), array('file' => $filename)
        ));
    }
    ...
    public function _readPathInfo() {
        ...
        if (!$folder) {
            ...
            $this->out(String::insert(
                            __d('migrations', 'Creates the following directory: :path', true), array('path' => APP_PATH . 'config' . DS . 'sql' . DS . 'migrations')
                    )
            );
            $this->_stop();
        }
     ...
     * @access protected
     */
    public function _exec($action, $filename, $classname) {
     ...
     * @access protected
     */
    public function _dateToTimestamp($date) {
    ...
    public function help() {
        ...
        $this->hr();
        $this->out(String::insert(__d('migrations', "Params:
	-connection <config>
